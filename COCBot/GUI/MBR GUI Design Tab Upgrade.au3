...
Local $x = 30, $y = 150
	$Laboratory = GUICtrlCreateGroup(getLocaleString("lblLaboratory"), $x - 20, $y - 20, 450, 65)
		...
		$chkLab = GUICtrlCreateCheckbox(getLocaleString("chkLab"), $x + 40, $y - 6, -1, -1)
			GUICtrlSetTip(-1, getLocaleString("tipChkLab"))
			GUICtrlSetOnEvent(-1, "chkLab")
		Local $sNames = getLocaleString("sNames")
		$lblNextUpgrade = GUICtrlCreateLabel(getLocaleString("lblNextUpgrade"), $x + 40, $y + 22, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$cmbLaboratory = GUICtrlCreateCombo("", $x + 95, $y + 18, 125, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetData(-1, $sNames, $aLabTroops[0][3])
			GUICtrlSetTip(-1, getLocaleString("tipCmbLaboratory",1))
			GUICtrlSetState(-1, $GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "cmbLab")
		$icnLabUpgrade = GUICtrlCreateIcon($pIconLib, $eIcnLaboratory, $x + 230, $y + 5, 32, 32)
			GUICtrlSetState(-1, $GUI_HIDE)

        $chkUpgradeKing = GUICtrlCreateCheckbox(getLocaleString("lblUpgradeKing"), $x + 300, $y - 8, -1, -1)
            GUICtrlSetTip(-1, getLocaleString("tipUpgradeKing"))
            GUICtrlSetOnEvent(-1, "ichkUpgradeKing")
        $chkUpgradeQueen = GUICtrlCreateCheckbox(getLocaleString("lblUpgradeQueen"), $x + 300, $y + 15, -1, -1)
