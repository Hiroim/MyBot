...
Local $x = 30, $y = 477
$grpOtherExpert = GUICtrlCreateGroup(getLocaleString("grpOtherExpert"), $x - 20, $y - 20, 205, 48)
	$chkTotalCampForced = GUICtrlCreateCheckbox(getLocaleString("chkTotalCampForced"), $x, $y-5, -1, -1)
...
Local $x = 240, $y = 150
$grpScheduler = GUICtrlCreateGroup(getLocaleString("grpScheduler"), $x - 20, $y - 20, 240, 225)
    $chkDonateHours = GUICtrlCreateCheckbox(getLocaleString("chkDonateHours"), $x - 8, $y)
...
Local $x = 240, $y = 463
$grpOtherExpert = GUICtrlCreateGroup(getLocaleString("grpOtherPhoto"), $x - 20, $y - 17, 240, 59)
